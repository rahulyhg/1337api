// Last modified: Sun Nov 01 2015 17:52:13 GMT-0200 (BRST)
...
"use strict";angular.module("angular-json-editor",[]).provider("JSONEditor",function(){function t(n){return angular.forEach(arguments,function(r){r!==n&&angular.forEach(r,function(r,o){n[o]&&n[o].constructor&&n[o].constructor===Object?t(n[o],r):n[o]=r})}),n}var n={defaults:{options:{iconlib:"bootstrap3",theme:"bootstrap3"}}};this.configure=function(r){t(n,r)},this.$get=["$window",function(r){var o=r.JSONEditor;return t(o,n),r.JSONEditor}]}).directive("jsonEditor",["$q","JSONEditor",function(t,n){return{restrict:"E",transclude:!0,scope:{schema:"=",startval:"=",buttonsController:"@",onChange:"&"},controller:["$scope","$attrs","$controller",function(t,n,r){var o,e,a=n.buttonsController;if(angular.isString(a)&&""!==a){e={$scope:t};try{o=r(a,e)}catch(i){throw new Error("json-editor: buttons-controller attribute must be a valid controller.")}}}],link:function(r,o,e,a,i){var l,s=t.when({}),c=t.when(null);if(r.isValid=!1,!angular.isString(e.schema))throw new Error("json-editor: schema attribute has to be defined.");angular.isObject(r.schema)&&(c=t.when(r.schema)),angular.isObject(r.startval)&&(l=r.startval,s=angular.isDefined(l.$promise)?t.when(l.$promise):t.when(l)),t.all([c,s]).then(function(t){var e=t[0].data||t[0],a=t[1];if(null===e)throw new Error("json-editor: could not resolve schema data.");r.editor=new n(o[0],{startval:a,schema:e});var l=r.editor;l.on("ready",function(){r.isValid=0===l.validate().length}),l.on("change",function(){"function"==typeof r.onChange&&r.onChange({$editorValue:l.getValue()}),r.$apply(function(){r.isValid=0===l.validate().length})});var s=i(r,function(t){return t});o.append(s)})}}}]);
//bootstrap.js
